...
namespace BSP.POS.NEGOCIOS.AcortarLinkService
{
    public class AcortarLinkService : IAcortarLinkInterface
    {
        ...
        public AcortarLinkService(IWebHostEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }
        public async Task<string> AcortarLink(string token)
        {
            string pathToJson = Path.Combine(_hostingEnvironment.ContentRootPath, "AcortarLinkService", "AcortarLinkJson", "AcortarLink.json");

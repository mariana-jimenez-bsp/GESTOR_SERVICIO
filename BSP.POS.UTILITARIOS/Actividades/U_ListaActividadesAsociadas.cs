...
namespace BSP.POS.UTILITARIOS.Actividades
{
    public class U_ListaActividadesAsociadas
    {
        ...
        public U_ListaActividadesAsociadas(string pId, string pConsecutivo_informe, string pCodigo_actividad, string pHoras_cobradas, string pHoras_no_cobradas, string pNombre_actividad, string pFecha)
        { 
            Id = pId;

...
namespace BSP.POS.UTILITARIOS.Clientes
{
    public class U_ListaClientes
    {
        ...
        public U_ListaClientes(string pCLIENTE, string pNOMBRE, string pALIAS, string pCONTACTO, string pCARGO, string pDIRECCION, string pTELEFONO, string pCONTRIBUYENTE,
